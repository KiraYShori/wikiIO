		...
		return (
		     ...
		     <div id="secao1" className="secao">
		           ...
		           <div className="container row">
		            ...
		            <li > São dados acessíveis a pessoas, empresas e organizações de maneira pública, de modo que possam ser utilizados para analisar tendências e padrões, resolver problemas complexos e  ajudar na tomada de decisão.
		            </li>
		            <li>
					Deve estar disponíveis publicamente para qualquer pessoa utilizar e serem licenciados de maneira a permitir sua reutilização
					</li>
